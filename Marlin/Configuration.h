...
#define STRING_CONFIG_H_AUTHOR "@brandstaetter, @grbd, @rennwaffen" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kozzlik v1.0.2"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_CALIBRATION_DEFAULT_POINTS 7
     ...
     #define PROBE_MANUALLY_STEP 0.025 // For Manual Bed Leveling (without probe)
  #endif

  #if ENABLED(ANYCUBIC_KOSSEL_PLUS)
    // Print surface diameter/2 minus unreachable space (avoid collisions with vertical towers).
    #define DELTA_PRINTABLE_RADIUS 116.0 // mm. From Anycubic Kossle linear plus source
    // Center-to-center distance of the holes in the diagonal push rods.
    #define DELTA_DIAGONAL_ROD 269.65 // mm. From Anycubic Kossle Linear plus source
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 417.40 }  // default steps per unit for Kossel (GT2, 20 tooth)
